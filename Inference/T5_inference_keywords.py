...
model = T5ForConditionalGeneration.from_pretrained('checkpoint_keywords_T5').to(device)
...
with open(input_file, 'r') as csv_file:
    ...
    for i, row in enumerate(csv_reader):
        ...
        # encode the context and keywords using the T5 tokenizer
    ...
    output_file="output_T5_keywords.csv"
