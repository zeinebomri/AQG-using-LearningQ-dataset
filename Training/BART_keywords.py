...
def convert_to_features(example_batch):
    ...
    input_texts = [f"{context} {kw} </s>" for context, kw in zip(example_batch['context'], keywords)]
...
torch.save(train_dataset, './BART_keywords_results/train_data.pt')
torch.save(valid_dataset, './BART_keywords_results/valid_data.pt')
...
for params in param_combinations:
    ...
    training_args = TrainingArguments(
        output_dir="./BART_keywords_results/run",
    ...
    if valid_loss < best_valid_loss:
        ...
        model.save_pretrained('checkpoint_keywords_BART')
